...
class AdRollTests(create_oauth2_tests(registry.by_id(AdRollProvider.id))):
    ...
    def get_mocked_response(self,
        ...
        return MockedResponse(200, """
              {"family_name": "%s", "name": "%s",
               "picture": "https://lh5.adrollusercontent.com/-GOFYGBVOdBQ/AAAAAAAAAAI/AAAAAAAAAGM/WzRfPkv4xbo/photo.jpg",
               "locale": "nl", "gender": "male",
               "email": "%s",
               "link": "https://plus.adroll.com/108204268033311374519",
    ...
    def test_account_connect(self):
        ...
        self.assertTrue(SocialAccount.objects.filter(user=user,
                                                     provider=AdRollProvider.id).exists())
